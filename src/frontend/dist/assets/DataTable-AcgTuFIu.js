import { c as createLucideIcon, j as jsxRuntimeExports, a3 as cn, r as reactExports, G as Search, J as ChevronDown, a as Button } from "./index-DZPPfMmg.js";
import { I as Input } from "./input-Clo9Nqqp.js";
import { C as ChevronUp } from "./chevron-up-Cdh06Vhn.js";
/**
...
function DataTable({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: table.getHeaderGroups().map((hg) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "bg-muted/20 hover:bg-muted/20", children: hg.headers.map((header) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        TableHead,
        {
          ...
          children: header.isPlaceholder ? null : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                header.column.getCanSort() && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1", children: header.column.getIsSorted() === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-3 w-3" }) : header.column.getIsSorted() === "desc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronsUpDown, { className: "h-3 w-3 opacity-40" }) })
              ]
            }
          )
        },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: isLoading ? ["r0", "r1", "r2", "r3", "r4"].map((rk) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        TableCell,
        {
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 bg-muted/40 rounded animate-pulse" })
        },
        String(
          col.id ?? col.accessorKey ?? String(col.header)
        )
      )) }, rk)) : table.getRowModel().rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        TableCell,
        {
